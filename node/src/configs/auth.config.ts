...
export const fetchUser = async (req: Request, res: Response, next: NextFunction) => {
	...
	if (req.path.includes("role") || req.path.includes("register") || req.path.includes("bike") || req.path.includes("accept") || req.path.includes("refuse") || req.path.includes("delete")) {
